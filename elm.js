							...
							return function (editingMessage) {
								return function (editedMessage) {
									return function (hasNameInputted) {
										return {editedMessage: editedMessage, editingMessage: editingMessage, hasNameInputted: hasNameInputted, isPublic: isPublic, myMessage: myMessage, page: page, privateRooms: privateRooms, publicRooms: publicRooms, roomID: roomID, userName: userName};
									};
								};
							};
						};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$Model($author$project$Main$Portal)('')(true)('')(_List_Nil)(_List_Nil)('')(_List_Nil)(_List_Nil)(false),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$EditedMsgRecv = function (a) {
	return {$: 'EditedMsgRecv', a: a};
};
var $author$project$Main$EditingMsgRecv = function (a) {
	return {$: 'EditingMsgRecv', a: a};
};
...
var $author$project$Main$editedMsgReceiver = _Platform_incomingPort(
	'editedMsgReceiver',
	A2(
...
var $author$project$Main$editingMsgReceiver = _Platform_incomingPort(
	'editingMsgReceiver',
...
var $author$project$Main$Room = {$: 'Room'};
...
var $author$project$Main$roomInfoSender = _Platform_outgoingPort(
	'roomInfoSender',
	function ($) {
...
var $author$project$Main$userNameSender = _Platform_outgoingPort('userNameSender', $elm$json$Json$Encode$string);
		...
		switch (msg.$) {
			case 'RoomInfoSend':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							isPublic: A2($elm$core$List$member, model.roomID, model.privateRooms) ? false : model.isPublic
						}),
			...
			case 'UserNameSend':
				return _Utils_Tuple2(
					...
					$author$project$Main$userNameSender(model.userName));
			case 'EditingMsgSend':
				...
				return _Utils_Tuple2(
					...
					$author$project$Main$editingMsgSender(editingMsg));
			case 'EditedMsgSend':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{myMessage: ''}),
					$author$project$Main$editedMsgSender(model.myMessage));
			case 'ExitRoomSend':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{hasNameInputted: false, page: $author$project$Main$Portal, userName: ''}),
			...
			case 'EditedMsgRecv':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							editedMessage: A2($elm$core$List$cons, editedMsg, model.editedMessage)
						}),
					$elm$core$Platform$Cmd$none);
			case 'EnterRoomRecv':
				var tmp = msg.a;
...
var $author$project$Main$EditedMsgSend = {$: 'EditedMsgSend'};
var $author$project$Main$EditingMsgSend = function (a) {
	return {$: 'EditingMsgSend', a: a};
};
var $author$project$Main$ExitRoomSend = {$: 'ExitRoomSend'};
var $author$project$Main$RoomIDChanged = function (a) {
	return {$: 'RoomIDChanged', a: a};
};
var $author$project$Main$RoomInfoSend = {$: 'RoomInfoSend'};
var $author$project$Main$RoomTypeChanged = {$: 'RoomTypeChanged'};
var $author$project$Main$UserNameChanged = function (a) {
	return {$: 'UserNameChanged', a: a};
};
var $author$project$Main$UserNameSend = {$: 'UserNameSend'};
...
var $author$project$Main$viewEditedMsg = function (msg) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(msg.name + (':' + (msg.message + ('(' + (msg.time + ')')))))
			]));
};
var $author$project$Main$viewEditingMsg = function (msg) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(msg.name + (':' + msg.message))
			]));
};
var $author$project$Main$viewRooms = function (publicRoom) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(publicRoom)
			]));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Main$ExitRoomSend)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$placeholder('room ID + Enter'),
									$elm$html$Html$Events$onInput($author$project$Main$RoomIDChanged),
									$author$project$Main$onEnter($author$project$Main$RoomInfoSend)
								]),
							_List_Nil)
						])),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('The room will be'),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Main$RoomTypeChanged)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Public rooms')
						])),
					A2(
					$elm$html$Html$ul,
					_List_Nil,
					A2($elm$core$List$map, $author$project$Main$viewRooms, model.publicRooms))
				]));
	} else {
		return A2(
			$elm$html$Html$div,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$placeholder('Your Name + Enter'),
									$elm$html$Html$Attributes$value(model.userName),
									$elm$html$Html$Events$onInput($author$project$Main$UserNameChanged),
									$author$project$Main$onEnter($author$project$Main$UserNameSend),
									$elm$html$Html$Attributes$disabled(
									model.hasNameInputted ? true : false)
								]),
							_List_Nil)
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$placeholder('message + Enter'),
									$elm$html$Html$Attributes$value(model.myMessage),
					...
					$elm$html$Html$ul,
					_List_Nil,
					A2($elm$core$List$map, $author$project$Main$viewEditingMsg, model.editingMessage)),
					A2(
					$elm$html$Html$ul,
					_List_Nil,
					A2($elm$core$List$map, $author$project$Main$viewEditedMsg, model.editedMessage))
				]));
	}
};
